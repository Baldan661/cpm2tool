...
# Copyright (C) Telmunn <me@Telmunn> - All Rights Reserved
# Unauthorized copying of this file, via any medium is strictly prohibited
# Proprietary and confidential
# Written by <Telmunn>, 05, May, 2024.

#############################################
# DO NOT BUY THIS TOOL FROM ANY SCAMMER !!! #
# OFFICIAL SELLER IS 'Kayzen1P' AT TELEGRAM !!! #
#############################################
...
__CHANNEL_USERNAME__ = "Telmun"
__GROUP_USERNAME__   = "Lalar"
