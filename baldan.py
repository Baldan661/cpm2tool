...
# Copyright (C) Telmunn <me@Telmunn.ly> - All Rights Reserved
# Unauthorized copying of this file, via any medium is strictly prohibited
# Proprietary and confidential
# Written by Telmunn <me@Telmunn.ly>, 05, May, 2024.

#############################################
# DO NOT BUY THIS TOOL FROM ANY SCAMMER !!! #
# OFFICIAL SELLER IS 'Telmunn' AT TELEGRAM !!! #
#############################################

BASE_URL: str = "https://whatareulookingfor.squareweb.app/api"
